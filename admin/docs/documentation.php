...
<head>
  ...
  <title>Documentation :: Vote Online&trade;</title>
  <!-- Favicon -->
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-10 text-center">
            <h1 class="display-2 text-white">Vote Online <small>v2.1.2</small> Documentation</h1>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4">
          <div class="card bg-gradient-default text-center p-5">
            <a href="https://voteonline.com.ng/documentation/" target="_blank" class="btn btn-white btn-icon mb-3 mb-sm-0">
